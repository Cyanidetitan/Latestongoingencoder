...
ffmpeg = "-map 0:v -map 0:a? -map 0:s? -c:v libx265 -pix_fmt yuv420p -x265-params 'no-info=1' -crf 25 -vf scale=-2:480 -preset slow -map_metadata -1 -tag:v hvc1 -c:a libfdk_aac -vbr 2 -ac 2 -profile:a aac_he_v2 -movflags +faststart -threads 2"
